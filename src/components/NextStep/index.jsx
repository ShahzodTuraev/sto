...
const FreeTrialStep1 = () => {
  ...
  return (
    <Container>
      ...
      { close && <BottomClose/> }
      <Main>
          <Tit>『CEO뉴스레터』 <br></br>회원을 축하합니다!</Tit>
          <Text>약속대로, 최신 AI기반 경제·경영·노하우 등<br /> 주요뉴스를 매일 3분요약 영상으로 보내드립니다.</Text>
          
          <Title>회원 축하기념,<br></br> 당일만 드리는 특별 혜택! </Title>
          <BoxWrap>
            <TitleWrap>
              ...
              <Box>
                ...
                <Button onClick={onClick} type={'full'}>책10권 이상의 노하우 비밀특강!<br></br>  『 1만원 』에 바로보기</Button>
            ...
            <TitleWrap>
              ...
              <Box>
                ...
                <Button onClick={onClick2} type={'full'}> 원하는 영상 "텍스트"만 입력시, <br></br>1분에 『 1만원 』 만들어보기</Button>
